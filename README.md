...
An interactive map of the process-bigraph / Vivarium 2.0 software ecosystem — the
...
- `loom.html` — the standalone bigraph-loom explorer embedded by the "Rendered by loom" section
